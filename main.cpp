...
public:
    ...
    virtual void Initialize_Data() 
    {
        ...
        Uniform_Update();
        // Add texture
        OpenGLTextureLibrary::Instance()->Add_Texture_From_File("background.jpg", "floor_color");
        screen_cover->Add_Texture("floor_color", OpenGLTextureLibrary::Get_Texture("floor_color"));

        OpenGLTextureLibrary::Instance()->Add_Texture_From_File("water.jpg", "water_color");
        screen_cover->Add_Texture("water_color", OpenGLTextureLibrary::Get_Texture("water_color"));

        OpenGLTextureLibrary::Instance()->Add_Texture_From_File("fire.jpg", "fire_color");
        screen_cover->Add_Texture("fire_color", OpenGLTextureLibrary::Get_Texture("fire_color"));

        OpenGLTextureLibrary::Instance()->Add_Texture_From_File("rock.jpg", "rock_color");
        screen_cover->Add_Texture("rock_color", OpenGLTextureLibrary::Get_Texture("rock_color"));
